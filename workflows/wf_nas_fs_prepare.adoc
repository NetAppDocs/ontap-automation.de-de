...
NOTE: Für ONTAP Versionen vor 9.9.1 lässt sich die Verwaltung der SACL und DACL Berechtigungen mithilfe der CLI Passthrough Funktion automatisieren. Weitere Informationen finden Sie unter link:../migrate/migration-considerations.html["Überlegungen zur Migration"].
