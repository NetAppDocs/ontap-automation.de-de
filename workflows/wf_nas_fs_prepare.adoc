...
NOTE: Für ONTAP Versionen vor 9.9.1 lässt sich die Verwaltung der SACL und DACL Berechtigungen mithilfe der CLI Passthrough Funktion automatisieren. Siehe link:../migrate/migration-considerations.html["Migrieren Sie von ONTAPI zur REST-API"] für weitere Informationen.
