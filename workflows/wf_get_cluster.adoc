...
Dieses Beispiel zeigt, wie ein einzelnes Feld abgerufen wird. Um die gesamte Cluster-Konfiguration abrufen zu können, müssen Sie den entfernen `fields` Abfrageparameter.
