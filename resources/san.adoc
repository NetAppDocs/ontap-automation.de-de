...
.LUN-Zuordnungen
Eine LUN-Zuordnung ist eine Verknüpfung zwischen einer LUN und einer Initiatorgruppe. Dieser Ressourcentyp wurde mit ONTAP 9.6 eingeführt und mit ONTAP 9.19.1 aktualisiert.
