...
Sicherheit:: Eine neue  `whoami`Funktion wurde hinzugefügt, um Benutzername, Rolle und Berechtigungsinformationen des angemeldeten Benutzers abzurufen. Die Web-Authentifizierung (WebAuthn) wurde ebenfalls verbessert.
