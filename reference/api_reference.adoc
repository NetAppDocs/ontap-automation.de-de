...
Sie können auf die aktuelle https://docs.netapp.com/us-en/ontap-restapi/getting_started_with_the_ontap_rest_api.html["ONTAP REST API Referenz"^] Dokumentation online. Es steht auch ein Versionswähler zur Verfügung, um auf frühere Versionen der Dokumentation basierend auf der ONTAP Version zuzugreifen.
...
. Als Beispiel für einen einzelnen API-Aufruf nach unten zur Kategorie *cluster* scrollen und *GET /cluster* auswählen.
