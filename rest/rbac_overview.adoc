...
NOTE: Bei der Verwendung jeder Rollenart gibt es vor- und Nachteile. Siehe link:../rest/work_roles_users.html#comparing-the-role-types["Vergleichen der Rollentypen"] Finden Sie weitere Informationen.
