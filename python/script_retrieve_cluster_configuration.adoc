...
summary: Sie können das Skript mit Python 3 in der CLI ausführen, um die ONTAP-Clusterkonfiguration abzurufen. 
---
= Skript zum Abrufen der Clusterkonfiguration mithilfe der Python-Client-Bibliothek
:hardbreaks:
:allow-uri-read: 
:nofooter: 
:icons: font
