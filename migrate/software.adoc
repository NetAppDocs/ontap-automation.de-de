...
Das NetApp ONTAP PowerShell Toolkit erweitert Ihre lokale PowerShell-Umgebung um ein Modul mit über 2.400 Cmdlets. Damit ist eine schnelle Entwicklung von Code für Ihren Windows-Host zur Automatisierung von ONTAP-Bereitstellungen möglich. Weitere Informationen finden sich unter link:../pstk/learn-about-pstk.html["Informationen zum NetApp ONTAP PowerShell Toolkit"].
