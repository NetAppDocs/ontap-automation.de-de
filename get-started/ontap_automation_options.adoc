...
.PowerShell Toolkit
Das NetApp ONTAP PowerShell Toolkit kann zur Automatisierung der Administration eines ONTAP Clusters von einem Windows Host verwendet werden. Weitere Informationen sind unter link:../pstk/learn-about-pstk.html["Informationen zum NetApp ONTAP PowerShell Toolkit"] verfügbar.
...
Der https://console.netapp.com/automationHub["NetApp Console Automatisierungszentrale"^] ist über die Webbenutzeroberfläche der Konsole verfügbar. Der Automatisierungshub bietet Zugriff auf vorkonfigurierte Lösungen, die Ihnen bei der Automatisierung der Bereitstellung und Integration von ONTAP mit anderen Produkten helfen können. Sehen https://docs.netapp.com/us-en/netapp-automation/["NetApp-Automatisierung"^] Dokumentation und weitere Informationen finden Sie hier.
